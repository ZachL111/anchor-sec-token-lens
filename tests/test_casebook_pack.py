"""Regression checks for the anchor-sec-token-lens casebook."""
...
from casebook.harness import assert_expected, anchor_sec_token_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_sec_token_lens_summary(), assert_expected())
